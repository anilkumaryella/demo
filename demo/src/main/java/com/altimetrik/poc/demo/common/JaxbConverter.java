	...
	protected void writeInternal(T t, HttpOutputMessage outputMessage)
		...
		try {
			...
			if (AnnotationUtils.findAnnotation(t.getClass(), XmlRootElement.class) != null) {
				...
				LOGGER.info("Plain xml [{}]", plainXml);

				String signXml = genUtils.generateSignature(plainXml);
				LOGGER.info("Signed XML [{}]", signXml);
				outputMessage.getBody().write(signXml.getBytes());
